document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (value.trim() !== '') {
        ...
        if (minLength && !validators.minLength(value, minLength)) {
          showError(field, errorMessages.minLength + ' (min ' + minLength + ' characters)');
          return false;
        }
      }
    ...
    function getFormFields() {
      return contactForm.querySelectorAll('input, textarea, select');
    }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "הבלרינות של מיקי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '3f4b4d91-9424-4d2e-ac86-2cdfa47c1a61',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '3f4b4d91-9424-4d2e-ac86-2cdfa47c1a61';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '3f4b4d91-9424-4d2e-ac86-2cdfa47c1a61';
